...
| **TailwindCSS v4.1** | Utility-first CSS framework used to rapidly build custom user interfaces directly in markup |
...
│   
├── src/
│   ├── main.jsx                    # App entry point, Recoil + Router + Tailwindcss theme
